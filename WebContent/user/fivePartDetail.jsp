		...
		<div class="row justify-content-center">
			<div class="card col-md-12">
				...
				<div class="row">
					...
					<c:set var="t" value="${0 }"/>
					<c:forEach var="e"  varStatus="i" items="${fiveList}" >
							...
							<div class="card text-dark bg-light">
								...
								<div class="card-body w-100">
									...
									<div class="list-group" id="question${i.count}">
										...
										<a  id="sel${t}" href="#" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action list-group-item-primary">
											${e.sel1_content}<span class="badge badge-primary badge-pill">${counter[t]}</span></a>
											
										<a id="sel${t+1}" href="#" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action list-group-item-primary">
											${e.sel2_content} <span class="badge badge-primary badge-pill">${counter[t+1]}</span></a>
											
										<a id="sel${t+2}" href="#" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action list-group-item-primary">
											${e.sel3_content}<span class="badge badge-primary badge-pill">${counter[t+2]}</span></a>
											
										<a id="sel${t+3}" href="#" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action list-group-item-primary">
											${e.sel4_content}<span class="badge badge-primary badge-pill">${counter[t+3]}</span></a>
										
										<a id="sel${t+4}" href="#" class="list-group-item d-flex justify-content-between align-items-center list-group-item-action list-group-item-primary">
											${e.sel5_content}<span class="badge badge-primary badge-pill">${counter[t+4]}</span></a>
