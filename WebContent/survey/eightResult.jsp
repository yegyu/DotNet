...
<html>
	...
	<body onscroll="SetDivPosition()">
		  ...
		  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <!-- colapse -->
				<div class="accordion w-100" id="eightResult">
					<c:set var="c" value="${0}"/>
					<c:forEach items="${choiceList}" varStatus="i">
					  <div class="card">
					    ...
					    <div id="Q${i.count}Sel" class="collapse" aria-labelledby="Q${i.count}" data-parent="#eightResult">
					      <div class="card-body alert-danger mb-0 pt-4">
								<h4>${resultList[c+1]}</h4>
					      </div>
					    </div>
					  </div>
		...
		<script type='text/javascript'>
		  ...
		  var addurl = '?s_num=${info.s_num}&friend=${info.id}&isMem='+isMem;
		  //<![CDATA[
		    ...
		    Kakao.Link.createCustomButton({
		      ...
		      templateId: 17181,
		      templateArgs: {
		        'url' : 'DotNet/eightMatch.do' + addurl
		      }
		    });
