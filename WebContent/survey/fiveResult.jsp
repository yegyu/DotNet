		  ...
		  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		    <div class="modal-content">
		      ...
		      <div class="modal-body">
		        ...
		        <!-- colapse -->
				<div class="accordion w-100" id="fiveResult">
					<c:set var="c" value="${0}"/>
					<c:forEach items="${choiceList}" varStatus="i">
					  <div class="card">
					    ...
					    <div id="Q${i.count}Sel" class="collapse" aria-labelledby="Q${i.count}" data-parent="#fiveResult">
		...
		<script type='text/javascript'>
		  ...
		  //<![CDATA[
		    ...
		    Kakao.Link.createCustomButton({
		      ...
		      templateId: 17188,
		      templateArgs: {
		        'url' : 'DotNet/fiveMatch.do' + addurl
		      }
		    });
